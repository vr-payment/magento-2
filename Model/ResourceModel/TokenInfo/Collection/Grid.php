 ...
 */
namespace VRPayment\Payment\Model\ResourceModel\TokenInfo\Collection;
 ...
 */
class Grid extends \VRPayment\Payment\Model\ResourceModel\TokenInfo\Collection
{
    ...
    protected function _initSelect()
    {
        ...
        $this->addCustomerIdFilter($this->registry->registry(RegistryConstants::CURRENT_CUSTOMER_ID))
            ->resetSortOrder();
        $this->join([
            'payment_method' => 'vrpayment_payment_method_configuration'

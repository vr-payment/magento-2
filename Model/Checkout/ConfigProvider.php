...
class ConfigProvider implements ConfigProviderInterface
{
    ...
    public function getConfig()
    {
        ...
        $config['vrpayment']['cspNonce'] = $this->cspNonceProvider->generateNonce();

        $config['vrpayment']['restoreCartUrl'] =
        $quote->getStore()->getUrl('vrpayment_payment/checkout/restoreCart', [
            '_secure' => true
        ]);
        ...
        if ($integrationMethod == IntegrationMethod::IFRAME) {
            ...
            try {
                $config['vrpayment']['paymentPageUrl'] = $quote->getStore()->getUrl(

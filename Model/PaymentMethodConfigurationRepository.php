...
use VRPayment\Payment\Api\Data\PaymentMethodConfigurationSearchResultsInterfaceFactory;
use VRPayment\Payment\Model\ResourceModel\PaymentMethodConfiguration as PaymentMethodConfigurationResource;
use VRPayment\Payment\Model\ResourceModel\PaymentMethodConfiguration\CollectionFactory as PaymentMethodConfigurationCollectionFactory;
...
class PaymentMethodConfigurationRepository implements PaymentMethodConfigurationRepositoryInterface
{
    ...
    {
        /** @var \VRPayment\Payment\Model\ResourceModel\PaymentMethodConfiguration\Collection $collection */
        $collection = $this->paymentMethodConfigurationCollectionFactory->create();

        $this->collectionProcessor->process($searchCriteria, $collection);

        /** @var \VRPayment\Payment\Api\Data\PaymentMethodConfigurationSearchResultsInterface $searchResults */

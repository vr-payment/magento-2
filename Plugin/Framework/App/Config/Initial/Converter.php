 ...
 */
namespace VRPayment\Payment\Plugin\Framework\App\Config\Initial;
...
use VRPayment\Payment\Model\Config\Dom;
use VRPayment\Payment\Model\Config\DomFactory;

/**
 * Interceptor to dynamically extend the initial configuration with the VRPay payment method data.
 */
class Converter
{
    ...
    private function getTemplate()
    {
        if ($this->template == null) {
            $templatePath = $this->moduleReader->getModuleDir(\Magento\Framework\Module\Dir::MODULE_ETC_DIR,
                'VRPayment_Payment') . '/config-method-template.xml';

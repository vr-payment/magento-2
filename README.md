...
* [Documentation](https://docs.plugin-documentation.vr-payment.de/vr-payment/magento-2/3.0.0/docs/en/documentation.html)
...
| Magento 2 Community Edition  | 2.4.8.                 | 3.x                    | Further notice         |
...
Please see the [license file](https://github.com/vr-payment/magento-2/blob/3.0.0/LICENSE) for more information.

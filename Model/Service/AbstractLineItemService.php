...
use VRPayment\Sdk\Model\TaxCreate;
...
abstract class AbstractLineItemService
{
    ...
    protected function convertLineItems($entity)
    {
        ...
        $this->eventManager->dispatch('vrpayment_payment_convert_line_items',
            [
                'transport' => $transport,
                'entity' => $entity
            ]);
    ...
    private function convertItem($entityItem, $entity)
    {
        ...
        $this->eventManager->dispatch('vrpayment_payment_convert_product_line_item',
            [
                'transport' => $transport,
     ...
     *
     * @param \Magento\Quote\Model\Quote\Item|\Magento\Sales\Model\Order\Item|\Magento\Sales\Model\Order\Invoice\Item $entityItem
     * @return \VRPayment\Sdk\Model\LineItemAttributeCreate[]
     */
    ...
    protected function getCustomAttributes($productId, $storeId)
    {
        ...
        $productAttributeCodeConfig = $this->scopeConfig->getValue(
            'vrpayment_payment/line_items/product_attributes', ScopeInterface::SCOPE_STORE, $storeId);
        ...
        $shippingDiscountAmount, $shippingDescription)
    {
        if ($shippingAmount > 0) {
            ...
            if ($this->scopeConfig->getValue('vrpayment_payment/line_items/overwrite_shipping_description',
            ...
            $this->eventManager->dispatch('vrpayment_payment_convert_shipping_line_item',
                [
                    'transport' => $transport,
                    'entity' => $entity
                ]);

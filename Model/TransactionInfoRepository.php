...
use VRPayment\Payment\Api\Data\TransactionInfoSearchResultsInterfaceFactory;
use VRPayment\Payment\Model\ResourceModel\TransactionInfo as TransactionInfoResource;
use VRPayment\Payment\Model\ResourceModel\TransactionInfo\CollectionFactory as TransactionInfoCollectionFactory;
...
class TransactionInfoRepository implements TransactionInfoRepositoryInterface
{
    ...
    {
        /** @var \VRPayment\Payment\Model\ResourceModel\TransactionInfo\Collection $collection */
        $collection = $this->transactionInfoCollectionFactory->create();

        $this->collectionProcessor->process($searchCriteria, $collection);

        /** @var \VRPayment\Payment\Api\Data\TransactionInfoSearchResultsInterface $searchResults */

...
* [Documentation](https://docs.plugin-documentation.vr-payment.de/vr-payment/magento-2/3.2.2/docs/en/documentation.html)
...
Please see the [license file](https://github.com/vr-payment/magento-2/blob/3.2.2/LICENSE) for more information.

...
class RestoreCartOnCartPage implements ObserverInterface
{
    ...
    public function execute(Observer $observer)
    {
        ...
        try {
            $this->eventManager->dispatch('vrpayment_validate_and_restore_quote');

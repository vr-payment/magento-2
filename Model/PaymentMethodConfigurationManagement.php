...
use VRPayment\Sdk\Service\PaymentMethodConfigurationService;
...
class PaymentMethodConfigurationManagement implements PaymentMethodConfigurationManagementInterface
{
    ...
    {
        $this->configWriter->save('payment/vrpayment_payment_' . $configuration->getEntityId() . '/' . $key,
            $value, $scope, $scopeId);
    }
     ...
     * @return bool
     */
    private function hasConfigurationChanged(\VRPayment\Sdk\Model\PaymentMethodConfiguration $configuration,

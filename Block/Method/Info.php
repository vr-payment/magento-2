...
use VRPayment\Payment\Model\Provider\LabelDescriptorGroupProvider;
use VRPayment\Payment\Model\Provider\LabelDescriptorProvider;
...
class Info extends \Magento\Payment\Block\Info
{
     ...
     * @var string
     */
    protected $_template = 'VRPayment_Payment::payment/method/info.phtml';
    ...
    /**
     * Gets the URL to the transaction detail view in VR payment.
     *
     * @return string
     */
    #[\ReturnTypeWillChange]
    ...
    {
        return \rtrim($this->_scopeConfig->getValue('vrpayment_payment/general/base_gateway_url'), '/') .
            '/s/' . $this->getTransaction()->getSpaceId() . '/payment/transaction/view/' .
            $this->getTransaction()->getTransactionId();
    }

    /**
     * Gets the URL to the customer detail view in VR payment.
     *
     * @return string
     */
    #[\ReturnTypeWillChange]
    ...
    public function getInvoiceDownloadUrl()
    {
        ...
        return $this->$class_backend->getUrl('vrpayment_payment/order/downloadInvoice',
            [
    ...
    {
        $class_backend = $this->isHelperBackend();
        return  $this->$class_backend->getUrl('vrpayment_payment/order/downloadPackingSlip',
            [
                'order_id' => $this->getTransaction()
                    ->getOrderId()
            ]);
    ...
    {
        $class_backend = $this->isHelperBackend();
        return $this->$class_backend->getUrl('vrpayment_payment/order/downloadRefund',
            [
    ...
    public function isRefundDownloadAllowed()
    {
        ...
        if ($this->getTransaction() && $creditmemo != null && $creditmemo->getVrpaymentExternalId() != null) {
            $storeId = null;
            if ($this->getInfo() instanceof Payment) {
                /** @var Payment $payment */
                $payment = $this->getInfo();

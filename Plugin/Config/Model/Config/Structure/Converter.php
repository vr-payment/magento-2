 ...
 */
namespace VRPayment\Payment\Plugin\Config\Model\Config\Structure;
...
use VRPayment\Payment\Model\Config\Structure\Reader;

/**
 * Interceptor to dynamically extend config structure with the VR Payment payment method data.
 */
class Converter
{
    ...
    /**
     * Inject dynamic payment method configuration into system config structure.
     *
    ...
    /**
     * Build the system config XML for a payment method configuration.
     *
    ...
    private function getTemplate()
    {
        if ($this->template == null) {
            $templatePath = $this->moduleReader->getModuleDir(
                ...
                'VRPayment_Payment'
            ) . '/adminhtml/system-method-template.xml';

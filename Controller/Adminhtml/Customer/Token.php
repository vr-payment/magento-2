 ...
 */
namespace VRPayment\Payment\Controller\Adminhtml\Customer;
...
/**
 * Backend controller action to delete VRPayment tokens.
 */
class Token extends \Magento\Customer\Controller\Adminhtml\Index
{
    ...
    public function execute()
    {
        ...
        if ($customerId && $tokenId) {
            try {
                /** @var \VRPayment\Payment\Model\TokenInfo $token */

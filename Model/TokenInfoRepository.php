...
use VRPayment\Payment\Api\Data\TokenInfoSearchResultsInterfaceFactory;
use VRPayment\Payment\Model\ResourceModel\TokenInfo as TokenInfoResource;
use VRPayment\Payment\Model\ResourceModel\TokenInfo\CollectionFactory as TokenInfoCollectionFactory;
...
class TokenInfoRepository implements TokenInfoRepositoryInterface
{
    ...
    {
        /** @var \VRPayment\Payment\Model\ResourceModel\TokenInfo\Collection $collection */
        $collection = $this->tokenInfoCollectionFactory->create();

        $this->collectionProcessor->process($searchCriteria, $collection);

        /** @var \VRPayment\Payment\Api\Data\TokenInfoSearchResultsInterface $searchResults */

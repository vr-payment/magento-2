...
namespace VRPayment\Payment\Model\Hyva\Checkout\Payment;
 ...
 * This class extends the AbstractPlaceOrderService provided by Hyva to integrate
 * the VRPayment payment logic into the Magewire-based checkout flow.
 */
if (\class_exists(AbstractPlaceOrderService::class)) {
    /**
     * Implementation for Hyva Checkout.
     */
    class PlaceOrderService extends AbstractPlaceOrderService
    {
        ...
        {
            return \str_starts_with($code, 'vrpayment_payment_');
        }
         ...
         * on the checkout page to let the VRPayment SDK take over.
         *
        ...
        public function getRedirectUrl(Quote $quote, ?int $orderId = null): string
        {
            ...
            if ($integrationMethod === IntegrationMethod::PAYMENT_PAGE) {
                return $quote->getStore()->getUrl(
                    'vrpayment_payment/checkout/paymentPageUrl',
                    [
                        '_secure' => true,
                    ],
                );
    ...
    /**
     * Fallback stub for environments where Hyva Checkout is not installed.
     * This prevents Fatal Errors during DI compilation in standard Luma-only setups.
     */
    class PlaceOrderService
    {
        /**
         * Stub constructor compatible with the standard signature.
         *

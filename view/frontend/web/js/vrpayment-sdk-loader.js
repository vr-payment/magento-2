    ...
    var WhitelabelMachineNameSDKLoader = {
        ...
        load: function (url) {
            return new Promise(function (resolve, reject) {
                ...
                if (window.checkoutConfig && window.checkoutConfig.vrpayment && window.checkoutConfig.vrpayment.cspNonce) {
                    script.setAttribute('nonce', window.checkoutConfig.vrpayment.cspNonce);
                }

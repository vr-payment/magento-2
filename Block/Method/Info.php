...
class Info extends \Magento\Payment\Block\Info
{
    ...
    {
        return \rtrim(
            $this->_scopeConfig->getValue('vrpayment_payment/general/base_gateway_url'),
            '/'
        ) .
        '/s/' .
    ...
    public function getInvoiceDownloadUrl()
    {
        ...
        return $this->$class_backend->getUrl(
            'vrpayment_payment/order/downloadInvoice',
            [
    ...
    public function getPackingSlipDownloadUrl()
    {
        $class_backend = $this->isHelperBackend();
        return  $this->$class_backend->getUrl(
            'vrpayment_payment/order/downloadPackingSlip',
            [
                'order_id' => $this->getTransaction()
                    ->getOrderId()
            ]
    ...
    public function getRefundDownloadUrl()
    {
        $class_backend = $this->isHelperBackend();
        return $this->$class_backend->getUrl(
            'vrpayment_payment/order/downloadRefund',
            [

...
namespace VRPayment\Payment\ViewModel;
...
/**
 * ViewModel to provide VRPayment payment configuration to the checkout.
...
class WhitelabelMachineNameCheckoutViewModel implements ArgumentInterface
{
    ...
    public function getPaymentIntegrationData(string $methodCode): array
    {
        ...
        return [
            ...
            'containerId' => 'vrpayment-iframe-' . $methodCode,
    ...
    {
        try {
            $entityId = (int) str_replace('vrpayment_payment_', '', $methodCode);
            if ($entityId) {

...
/**
 * Interceptor to dynamically extend the layout configuration with the VR Payment payment method data.
 */
class LayoutProcessor
{
    ...
    public function beforeProcess(\Magento\Checkout\Block\Checkout\LayoutProcessor $subject, $jsLayout)
    {
        ...
        if (isset(
            ...
            ['payment']['children']['renders']['children']['vrpayment_payment']['methods']
        )) {
            ...
            foreach ($configurations as $configuration) {
                $jsLayout['components']['checkout']['children']['steps']['children']['billing-step']['children']
                ['payment']['children']['renders']['children']['vrpayment_payment']['methods']
                ['vrpayment_payment_' . $configuration->getEntityId()] = $this->getMethodData();
            }
        }

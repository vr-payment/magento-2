...
use VRPayment\Payment\Api\Data\RefundJobSearchResultsInterfaceFactory;
use VRPayment\Payment\Model\ResourceModel\RefundJob as RefundJobResource;
use VRPayment\Payment\Model\ResourceModel\RefundJob\CollectionFactory as RefundJobCollectionFactory;
...
class RefundJobRepository implements RefundJobRepositoryInterface
{
    ...
    {
        /** @var \VRPayment\Payment\Model\ResourceModel\RefundJob\Collection $collection */
        $collection = $this->refundJobCollectionFactory->create();

        $this->collectionProcessor->process($searchCriteria, $collection);

        /** @var \VRPayment\Payment\Api\Data\RefundJobSearchResultsInterface $searchResults */
